...
void SCVars::InitVRCVars(IConsole* pConsole)
{
	...
	pConsole->Register("vr_winlatorxr_menu_panel", &vr_winlatorxr_menu_panel, 0, VF_RESTRICTEDMODE|VF_DUMPTODISK, "Under WinlatorXR, show menus and loading screens on a panel fixed in the room (like on PC) instead of on WinlatorXR's flat screen, which follows the head");
